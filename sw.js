...
const VERSION = 'eiszeit-eedc769e';
const SCHALE = [
  './',
  './index.html',
  './guides.html',
  ...
  './taeglich.html',
  './konto.html',
  './assets/style.css?v=eedc769e',
  './assets/data.js?v=eedc769e',
  './assets/draft.js?v=eedc769e',
  './assets/engine.js?v=eedc769e',
  './assets/ereignisse.js?v=eedc769e',
  './assets/wappen.js?v=eedc769e',
  './assets/ui.js?v=eedc769e',
  './assets/game.js?v=eedc769e',
  './assets/konto-config.js?v=eedc769e',
  './assets/konto.js?v=eedc769e',
  './assets/bestenliste.js?v=eedc769e',
  './manifest.json',
